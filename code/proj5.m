...
trainingData = [features_pos; features_neg];

posLabels = ones(size(features_pos, 1), 1);
negLabels = (ones(size(features_neg, 1), 1)) * -1;
...
% trianing data.
% [~, ~, ~, hnFeatures] = run_detector(non_face_scn_path, w, b, feature_params);
